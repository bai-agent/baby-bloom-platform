...
export function BsrShareClient({ initialData }: Props) {
  ...
  const profileUrl = `${typeof window !== "undefined" ? window.location.origin : ""}/babysitting/${initialData.bsrId}`;
  ...
  const handleNativeShare = useCallback(async () => {
    ...
    try {
      await navigator.share({
        title: `Babysitter needed in ${initialData.suburb}`,
        text: cleanPost ?? "",
        url: profileUrl,
      });
      await markAsShared();
  ...
  if (!cleanPost) {
    return (
      <div className="mx-auto max-w-2xl space-y-6">
        <h1 className="text-2xl font-bold text-slate-800">Share Your Request</h1>
      ...
      <div>
        ...
        {isAccessGranted ? (
          <p className="text-sm text-green-600 mt-1 font-medium flex items-center justify-center gap-1.5">
            ...
            We are finding your Babysitter right now!
          </p>
        ) : (
          ...
          <AccordionContent>
            <div className="px-4 space-y-3">
              <ol className="text-sm text-slate-600 space-y-2 list-decimal list-inside">
                ...
                <li>Get Babysitter!!</li>
              </ol>
              <p className="text-xs text-slate-400">
                In less than 2 minutes we will be getting your Babysitter!
              </p>
              <Button
                id="cta-how-it-works"
                onClick={() => {
            ...
            <AccordionItem value="copy" className="border-0">
              ...
              <AccordionContent forceMount className="overflow-hidden">
                <p className="text-xs text-slate-400 mb-3">
                  We created the perfect post for your babysitting request designed to attract trusted sitters
                </p>
                ...
                <div className="rounded-lg border overflow-hidden bg-white mb-3 w-full max-w-full">
                  ...
                  <div className="mx-3 mb-3 rounded-lg border border-[#ddd] overflow-hidden bg-[#f0f2f5]">
                    <div className="aspect-[1.91/1] bg-violet-50 overflow-hidden">
                      {/* eslint-disable-next-line @next/next/no-img-element */}
                      <img
                        src={`/api/og/babysitting/${initialData.bsrId}`}
                        alt="Share preview"
                    ...
                    <div className="p-3 border-t border-[#ddd]">
                      ...
                      <p className="text-sm font-semibold text-[#050505] mt-0.5">
                        The {initialData.lastName ?? initialData.firstName} family needs an experienced babysitter | apply now
                      </p>
                    </div>
                  </div>
              ...
              <AccordionContent forceMount>
                <div className="space-y-3">
                  <p className="text-sm text-slate-500">
                    Share your request to a relevant Facebook group.
                  </p>
                ...
                <div className="space-y-3">
                  ...
                  {isAccessGranted && (
                    <div className="rounded-lg bg-green-50 border border-green-200 p-4 flex items-center gap-3">
                      ...
                      <div>
                        <p className="font-medium text-green-800">We are finding your Babysitter right now!</p>
                        <p className="text-sm text-green-600">We will notify you the first 5 responders so you can confirm your babysitter personally.</p>
                      </div>
                    </div>
                  )}
